# -*- coding: utf-8 -*-
"""after_recieving_call.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/15JtAyzsvsA25kNWKHeReNDBpiuHEaF99
"""
...
response = requests.get("http://54.180.109.46:5000/")             # task_data 정보 
task_data = response.json()

task_data

data = {"unit_id": "1", "pos_x": "3.0", "pos_y": "2.0"}
response_request = requests.post("http://54.180.109.46:5000/current_pos", json = data)
...
data = {"unit_id": "4"}
response_request = requests.get("http://54.180.109.46:5000/current_pos", json = data)
request_data = response_request.json()

request_data       #request_data["pos_x"]

data = {"unit_id": "1", "task_id": "3"}
response_request = requests.post("http://54.180.109.46:5000/score_request", json = data)
request_data = response_request.json

request_data

data = {"unit_id": "1"}
response_request = requests.get("http://54.180.109.46:5000/score_request", json = data)
request_data = response_request.json()

request_data

response = requests.get("http://54.180.109.46:5000/")
task_data = response.json()  
                                         # 출발, 종료, 현재 각각 x, y 좌표 받아오기 (완료)
id_data = {"unit_id": "1"}
response_request = requests.get("http://54.180.109.46:5000/current_pos", json = id_data)
request_data = response_request.json()
...
def get_pos_x_as_integer(unit_id):
    ...
    response = requests.get("http://54.180.109.46:5000/current_pos", json=data)
...
data = {"task_id": "3", "unit_id": "1", "score": courier1_score}
response_request = requests.post("http://54.180.109.46:5000/score", json = data)
request_data = response_request.json

data = {"task_id": "2", "unit_id": "2", "score": courier2_score}
response_request = requests.post("http://54.180.109.46:5000/score", json = data)
request_data = response_request.json

data = {"task_id": "5", "unit_id": "3", "score": courier3_score}
response_request = requests.post("http://54.180.109.46:5000/score", json = data)
request_data = response_request.json

data = {"task_id": "2", "unit_id": "4", "score": courier4_score}
response_request = requests.post("http://54.180.109.46:5000/score", json = data)
request_data = response_request.json

data = {"task_id": "5", "unit_id": "5", "score": courier5_score}
response_request = requests.post("http://54.180.109.46:5000/score", json = data)
request_data = response_request.json

request_data

data = {"task_id": "3", "unit_id": "1"}
response_request = requests.get("http://54.180.109.46:5000/score", json = data)
request_data = response_request.json()

request_data

data = {"task_id": "2", "unit_id": "2"}
response_request = requests.get("http://54.180.109.46:5000/score", json = data)
request_data = response_request.json()

request_data

data = {"task_id": "5", "unit_id": "3"}
response_request = requests.get("http://54.180.109.46:5000/score", json = data)
request_data = response_request.json()

request_data

data = {"task_id": "2", "unit_id": "4"}
response_request = requests.get("http://54.180.109.46:5000/score", json = data)
request_data = response_request.json()

request_data

data = {"task_id": "5", "unit_id": "5"}
response_request = requests.get("http://54.180.109.46:5000/score", json = data)
request_data = response_request.json()
...
request_data_A = []
request_data_A.append(request_data["task_id"])
