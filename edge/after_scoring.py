...
Original file is located at
    https://colab.research.google.com/drive/16Wn5F_aKkXokasqOAE5lyGlAa4u9F5-H
"""
...
data = {"task_id": task_id_1, "unit_id": "1"}
response_request = requests.get("http://54.180.109.46:5000/score", json = data)
request_data_1 = response_request.json()

request_data_1

data = {"task_id": task_id_2, "unit_id": "2"}
response_request = requests.get("http://54.180.109.46:5000/score", json = data)
request_data_2 = response_request.json()

request_data_2

data = {"task_id": task_id_3, "unit_id": "3"}
response_request = requests.get("http://54.180.109.46:5000/score", json = data)
request_data_3 = response_request.json()

request_data_3

data = {"task_id": task_id_4, "unit_id": "4"}
response_request = requests.get("http://54.180.109.46:5000/score", json = data)
request_data_4 = response_request.json()

request_data_4

data = {"task_id": task_id_5, "unit_id": "5"}
response_request = requests.get("http://54.180.109.46:5000/score", json = data)
request_data_5 = response_request.json()
